import { newGame } from "./game/game_state.js";
import { openCell } from "./game/floodfill.js";
import { applyOpenResult } from "./game/game_logic.js";
import { createBoardButtons, renderBoard } from "./ui/renderer_dom.js";
import { bindBoardInput } from "./ui/input.js";
import { updateHud, setStatus } from "./ui/hud.js";
import { PooledAudioPlayer } from "./audio/audio_player.js";
import { SFX } from "./assets/manifest.js";
...
const boardRoot = document.querySelector("#boardRoot");

let currentDifficulty = difficulties[0];
let model = newGame(currentDifficulty);
...
function requestGeneration(pos) {
...
worker.onmessage = (ev) => {
  const msg = ev.data;
  if (msg.type === WorkerMessageType.GENERATE_OK) {
  ...
  if (msg.type === WorkerMessageType.GENERATE_FAIL) {
    model.generationAttempts += msg.attempts;
